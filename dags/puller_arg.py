...
@dag(default_args=default_args, schedule_interval='*/30 * * * *', start_date=datetime(2021, 7, 23, 9, 0), tags=['idirect_arg'])
def puller_idirect_argentina():
...
puller_idirect_arg = puller_idirect_argentina()
# [END dag_invocation]
